...
const addressSlice = createSlice({
    ...
    initialState,
    reducers: {
        resetAddressStatus: (state) => { state.status = 'idle' },
        resetAddressAddStatus: (state) => { state.addressAddStatus = "idle" },
        resetAddressDeleteStatus: (state) => { state.addressDeleteStatus = "idle" },
        resetAddressUpdateStatus: (state) => { state.addressUpdateStatus = "idle" },
    },
