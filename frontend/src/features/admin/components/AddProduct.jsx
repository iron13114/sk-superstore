...
export const AddProduct = () => {
    ...
    const [tiers, setTiers] = useState([
        { type: 'single', label: 'Single Unit', quantity: 1, basePrice: '', discountPercentage: 0, stockQuantity: '' },
        { type: 'pack', label: 'Pack', quantity: '', basePrice: '', discountPercentage: 5, stockQuantity: '' },
        { type: 'carton', label: 'Carton', quantity: '', basePrice: '', discountPercentage: 10, stockQuantity: '' }
    ])
    ...
    const handleTierChange = (index, field, value) => {
        setTiers(prev => {
            ...
            // Auto-update label when quantity is typed
            if (field === 'quantity') {
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-300 pb-3">
                        <div>
                            ...
                            <p className="text-xs text-gray-500">
                                Select packaging options you want retailers to purchase for this product.
                            </p>
                        </div>
                                ...
                                <div key={tier.type} className="bg-white border border-gray-200 p-4 rounded shadow-xs relative">
                                    <div className="flex items-center justify-between mb-3">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {/* Input removed completely for Single Unit */}
                                            {!isSingle && (
                                                <input
                                                    type="text"
                                                    value={tier.label}
                                                    ...
                                                    className="text-sm font-semibold text-[#111827] border-b border-dashed border-gray-300 focus:border-[#0055A4] focus:outline-none px-1"
                                                />
                                            )}
                                        </div>
